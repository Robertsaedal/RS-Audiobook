  ...
  <button @click="emit('click')" class="relative group w-full h-52 flex flex-col justify-end pt-8 transition-all">
    <div class="relative w-32 md:w-40 h-48 mx-auto">
      ...
      <div v-if="stackCovers.length > 2" 
        ...
        :style="{ backgroundImage: `url(${stackCovers[2]})`, backgroundSize: 'cover', backgroundPosition: 'center' }"
      />
      ...
      <div v-if="stackCovers.length > 1" 
        ...
        :style="{ backgroundImage: `url(${stackCovers[1]})`, backgroundSize: 'cover', backgroundPosition: 'center' }"
      />
